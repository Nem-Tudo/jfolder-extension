...
[Download Installer](/installer/JFolder%20Setup%201.0.2.exe)

Allow AIs to return folders with different files using the .jfolder extension!

Viewer / Convert
![Viewer](/assets/preview.png)
...
1) BASIC FORMAT
- A .jfolder must be a single valid JSON object (top-level).
...
Reply this message only with "Ok. I can work with jfolder now."
